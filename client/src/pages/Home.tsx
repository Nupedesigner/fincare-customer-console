...
function ConversationDetail({ back }: { back: () => void }) {
  ...
  const sendReply = () => { setReplySent(true); toast("Human response sent", { description: "The reply has been sent through the customer’s existing web conversation." }); };
